            ...
            <section className="relative min-h-[65vh] flex flex-col justify-center items-center pt-24 pb-20 overflow-hidden">
                <div className="absolute inset-0">
                    <img
                        ...
                        alt="High efficiency modern wall-hung boiler system"
                        ...
                        <div className="relative">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="aspect-square rounded-2xl overflow-hidden shadow-lg mt-8">
                                    <img src="https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=2070&auto=format&fit=crop" alt="Technician inspecting boiler components" className="w-full h-full object-cover" />
                                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 relative">
                            <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1554224154-26032ffc0d04?q=80&w=2026&auto=format&fit=crop" alt="High efficiency modern modulating-condensing boiler" className="w-full h-full object-cover" />
                            </div>
