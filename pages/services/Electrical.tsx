...
export const Electrical: React.FC = () => {
    ...
    return (
        <div className="bg-white">
            <SEO
                title="Licensed Electrician Boston | Residential Electrical Services"
                description="Safe and reliable electrical repairs, panel upgrades, and installations in Greater Boston. Our licensed electricians ensure your home's safety."
                keywords="licensed electrician Boston, home electrical repairs, panel upgrades Massachusetts, residential electrical service"
                canonical="https://awpumahome.com/services/electrical"
            />
            {/* 1. THE PROMISE (HERO) */}
